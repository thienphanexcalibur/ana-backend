...
var CommentController = /** @class */ (function (_super) {
    ...
    function CommentController(model) {
        ...
        _this.postController = new _controller_1.PostController(_entity_1.PostModel);
        return _this;
    }
    CommentController.prototype.addComment = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, comment, byUser, post, newComment, newCommentId, updatedCommentPost, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, comment = _a.comment, byUser = _a.byUser, post = _a.post;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, this.add({ comment: comment, byUser: byUser, post: post })];
                    case 2:
                        newComment = _b.sent();
                        newCommentId = newComment._id;
                        return [4 /*yield*/, this.postController.addComment(post, newCommentId)];
                    case 3:
    ...
    CommentController.prototype.editComment = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, title, content, modifiedPost, e_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        ...
                        return [4 /*yield*/, this.modify(id, { title: title, content: content, updated_date: Date.now() })];
                    case 1:
    ...
    CommentController.prototype.deleteComment = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CommentController.prototype.getPost = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var id, post, e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
